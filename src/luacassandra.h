#ifndef luacassandra_h	// TODO: rename definition to a unique name
#define luacassandra_h	// TODO: rename definition to the same unique name

#define LTLIB_LIBRARYNAME luacassandra   // TODO: Update module name here
...
// Name for storing userdata in registry;		"luacassandra.lib_udata"
#define LTLIB_UDATANAME  LTLIB_STR( LTLIB_LIBRARYNAME##_lib_udata)
// Name of metatable for userdata;				"luacassandra.lib_udata_mt"
#define LTLIB_UDATAMT    LTLIB_STR( LTLIB_LIBRARYNAME##_lib_udata_mt)
// name of luaopen function;					luaopen_luacassandra
#define LTLIB_OPENFUNC   LTLIB_CONCAT(luaopen_,LTLIB_LIBRARYNAME)
// name of the global table for the module;		"luacassandra" || NULL
